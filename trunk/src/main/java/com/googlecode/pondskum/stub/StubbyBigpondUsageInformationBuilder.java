...
public final class StubbyBigpondUsageInformationBuilder {
    ...
    public BigpondUsageInformation build() {
        ...
        bigpondUsageList.add(new BigpondMonthlyUsageImpl("Jan", createUsage("1000", "500", "250", "1750")));
        bigpondUsageList.add(new BigpondMonthlyUsageImpl("Feb", createUsage("5000", "1000", "50", "6050")));

        BigpondUsage totalUsage = createUsage("6000", "1500", "300", "7800");

        return new BigpondUsageInformationImpl(accountInformation, bigpondUsageList, totalUsage);
    }

    private BigpondUsage createUsage(final String downloadUsage, final String uploadUsage, final String unmeteredUsage,
